...
@section('content')
    <div class="container py-4">
        ...
        <img src="https://lh3.googleusercontent.com/-20Gj8SfXsRhaFr13Maua1FYguxJXFKgosF9OGDV31a8tXupMN3gzFPGhB6lV9dOW1ulJseURIIu0O5_3-IjZOzREyXiFcu1GVwJbQ=w960" width="250px">
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-8">
